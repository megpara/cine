...
export default function Header() {
    ...
    return (
        <div>
        <div className="z-10 fixed w-screen text-white font-display flex justify-between text-md p-4 tracking-wide h-[60px] items-center">
            <Link href="/" className="hover:text-[#2700f9]">Colin Lupe</Link>
            <div className="space-x-4 flex">
                <button onClick={() => toggleAbout()} className="hover:text-[#2700f9] flex items-center text-sm transition-colors duration-150">
        ...
        <AboutModal open={aboutOpen} toggle={toggleAbout} />
        </div>
    )
}