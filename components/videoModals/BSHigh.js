...
export default function BSHigh({ open, toggle }) {
            ...
            <div className="content flex flex-col items-center justify-center z-60 w-screen h-screen">
                <motion.div 
                    ...
                    <div className="text-sm font-display uppercase leading-8 text-center">
                        <div className="text-lg">BS High</div>
                        Production Company: Dirty Robber <br />
                        Directors: Martin Roe & Travon Free <br />
                        Director of Photography: David Markun <br />
                        Additional Cinematography: Colin Lupe
                    </div>
                </motion.div>
            </div>
