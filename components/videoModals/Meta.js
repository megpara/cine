...
export default function Meta({ open, toggle }) {
            ...
            <div className="content flex flex-col items-center justify-center z-60 w-screen h-screen">
                <motion.div 
                    ...
                    <div className="relative w-full pt-[56.25%] pb-12 px-12" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                        <iframe
                            src="https://player.vimeo.com/video/687216515?h=e19ab69958&badge=0&autopause=0&player_id=0&app_id=58479&title=0&portrait=0&byline=0"
                            frameBorder="0"
                    ...
                    <div className="text-sm font-display uppercase leading-8 pt-12 text-center">
                        <div className="text-lg">Black History Month</div>
                        Director:  <br />
                        Editor: Colin Lupe <br />
