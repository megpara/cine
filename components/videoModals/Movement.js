...
export default function Movement({ open, toggle }) {
            ...
            <div className="content flex flex-col items-center justify-center z-60 w-screen h-screen">
                <motion.div 
                    ...
                    <div className="relative w-full pt-[56.25%] pb-12 px-12" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                        <iframe
                            src="https://player.vimeo.com/video/913127909?h=fa45fe90a1&badge=0&autopause=0&player_id=0&app_id=58479&title=0&portrait=0&byline=0"
                            frameBorder="0"
                    ...
                    <div className="text-sm font-display uppercase leading-8 text-center">
                        <div className="text-lg">Dam</div>
                        Director, DP, Editor: Colin Lupe <br />
                        Dancer: Megan Paradowski
                    </div>
                </motion.div>
            </div>
